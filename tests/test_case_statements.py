...
def test_case(sqlite_con_3):
    ...
    case_statement = sql_gen_case_stmt_numeric_abs_3(
        "float_col", gamma_col_name="0", abs_amount=1
    )
    ...
    case_statement = sql_gen_case_stmt_numeric_abs_4(
    ...
    case_statement = sql_gen_case_stmt_numeric_perc_3(
        "float_col", per_diff=0.01, gamma_col_name="0"
    )
    sql = f"""select {case_statement} from float_comp"""
    ...
    case_statement = sql_gen_case_stmt_numeric_perc_3(
        "float_col", per_diff=0.20, gamma_col_name="0"
    )
    sql = f"""select {case_statement} from float_comp"""
    ...
    case_statement = sql_gen_case_stmt_numeric_perc_4(

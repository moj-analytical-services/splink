...
def db():
    ...
    cur.execute("create table test2 (unique_id_l, unique_id_r, fname_l, fname_r, sname_l, sname_r)")
    cur.execute("insert into test2 values (?, ?, ?, ?, ?, ?)", (1, 2, "robin", "robin", "linacre", "linacre"))
    cur.execute("insert into test2 values (?, ?, ?, ?, ?, ?)", (3, 4, "robin", "robin", "linacrr", "linacre"))
    cur.execute("insert into test2 values (?, ?, ?, ?, ?, ?)", (5, 6, None, None, None, "linacre"))
    cur.execute("insert into test2 values (?, ?, ?, ?, ?, ?)", (7, 8, "robin", "julian", "linacre", "smith"))
...
def test_add_gammas(db):
    ...
    correct_col_names  = ['unique_id_l', 'unique_id_r', 'fname_l', 'fname_r', 'sname_l', 'sname_r', 'gamma_0', 'gamma_1']

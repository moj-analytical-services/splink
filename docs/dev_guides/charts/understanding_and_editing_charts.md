...
Basic chart display and HTML export do not require Altair. Install
`splink[altair]` and use `chart.altair_chart` when you want to customise a
Splink chart with Altair or use Altair's advanced export formats.

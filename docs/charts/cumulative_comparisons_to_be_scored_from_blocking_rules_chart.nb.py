...
#
#     **API Documentation:** [chart_comparisons_from_blocking_rules()](../api_docs/blocking_analysis.md#splink.blocking_analysis.chart_comparisons_from_blocking_rules)
#
...
#
# The `chart_comparisons_from_blocking_rules` chart shows the count of pairwise comparisons generated by a set of blocking rules.
#
...
chart = chart_comparisons_from_blocking_rules(
    splink_dataframe_or_dataframes=df_sdf,
    blocking_rules=blocking_rules_for_analysis,
    link_type="dedupe_only",
)

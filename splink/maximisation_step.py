...
def maximisation_step(
    ...
    sql_pipeline = _compute_new_parameters(settings_obj, sql_pipeline, generate_sql)
...
def expectation_maximisation(em_training_session, sql_pipeline, generate_sql):
    ...
    for i in range(max_iterations):
        sql_pipeline = predict(settings_obj, sql_pipeline, generate_sql)
        maximisation_step(
            em_training_session,
            sql_pipeline,
            generate_sql,

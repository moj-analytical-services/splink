    ...
    def _train(self):
        ...
        if not cvv.as_record_dict(limit=1):
            ...
            raise EMTrainingException(
                ...
                "Expectation maximisation requires a set of "
                "record comparisons to work on. "
                "You must revise your training blocking rule so that "
                "the set of generated comparisons is not empty."
            )

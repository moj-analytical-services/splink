...
def block_using_rules_sqls(
    *,
    ...
    for each unique pair. This approach is more efficient for columnar databases
    than the previous NOT-clause filtering approach.
    ...
    # Always deduplicate pairs using GROUP BY, keeping the minimum match_key
    # This replaces the previous approach of using NOT clauses to exclude
    # pairs generated by preceding rules
    sqls.append(

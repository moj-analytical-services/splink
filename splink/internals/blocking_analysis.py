...
def count_comparisons_from_blocking_rules(
    ...
    *,
    ...
    the cost of some accuracy.  ``record_sample_proportion=1.0`` (the default)
    computes exact counts.
    ...
    Args:
        ...
        record_sample_proportion (float, optional): The sampling proportion applied
            to each side of the blocking join.  Values below 1.0 estimate the counts
            from a sample (faster, approximate); 1.0 computes exact counts.  Defaults
            to 1.0.
...
def chart_comparisons_from_blocking_rules(
    ...
    *,
    ...
    Args:
        ...
        unique_id_column_name (str, optional):  Defaults to "unique_id".
        source_dataset_column_name (Optional[str], optional):  Defaults to None.
        record_sample_proportion (float, optional): Defaults to 1.0.

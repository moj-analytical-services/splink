...
class Linker:
    ...
    def _validate_settings(self, validate_settings: bool):
        """Validate our settings after constructing _settings_obj_.
        This applies a number of checks to ensure that the user's inputs
        are all valid given their dataframe(s) and linker selection.

        This will be moved to sit within settings.py in a future update.
        """
        ...
        InvalidTypesAndValuesLogger(self)._validate_dialect()

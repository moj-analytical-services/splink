...
from .blocking import BlockingRule, block_using_rules_sql, blocking_rule_to_obj
from .charts import (
    completeness_chart,
...
class Linker:
    ...
    def count_num_comparisons_from_blocking_rule(
        ...
        Examples:
            ...
            ```py
            import splink.duckdb.blocking_rule_library as brl
            br = brl.exact_match_rule("first_name")
            linker.count_num_comparisons_from_blocking_rule(br)
            ```
            > 19387
    ...
    def estimate_probability_two_random_records_match(
        ...
        deterministic_matching_rules = ensure_is_list(deterministic_matching_rules)

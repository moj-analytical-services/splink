...
from .match_key_analysis import (
    count_pairwise_comparisons_by_prediction_blocking_rules_sql,
)
...
class Linker:
    ...
    def count_pairwise_comparisons_by_prediction_blocking_rules(self, df_predict):
        sql = count_pairwise_comparisons_by_prediction_blocking_rules_sql(df_predict)
        """Counts the number of edges and expected number of edges for each
        match key (0, 1)
        ...
        Examples:
            ...
            >>> count_pairwise =
            linker.count_pairwise_comparisons_generated_by_prediction_blocking_rules(
                df_predict)
            >>> count_pairwise.as_pandas_dataframe(limit=5)

        Returns:
            DataFrame: A SplinkDataFrame of the pairwise comparisons and

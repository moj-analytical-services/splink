...
def _cumulative_comparisons_to_be_scored_from_blocking_rules(
    *,
    ...
    if len(records) == 0:
        # records = [{'row_count': 0, 'rule': 'l.surname = r.surname', 'cumulative_rows': 0, 'cartesian': cartesian_count,  'start': 0}]
        raise ValueError("No comparisons generated by blocking rules")

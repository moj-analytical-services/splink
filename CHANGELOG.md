...
- When using DuckDB, deterministic sampling uses a hash based on the unique id (if provided) [#3122](https://github.com/moj-analytical-services/splink/pull/3122)
